...
export const AdminMessage: React.FC<{ message: MessageModel,submitResponseToQuestion:any }> = (props, key) => {
    ...
    function submitBtn(){
        if(props.message.messageId!==null && response!==''){
            props.submitResponseToQuestion(props.message.messageId,response);
    ...
    return (
        <div key={props.message.messageId}>
            <div className='card mt-2 shadow p-3 bg-body rounded'>
                <h5>Case #{props.message.messageId}: {props.message.title}</h5>

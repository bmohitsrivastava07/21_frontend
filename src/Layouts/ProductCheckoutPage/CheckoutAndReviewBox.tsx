...
export const CheckoutAndReviewBox: React.FC<{ product: ProductModel | undefined, mobile: boolean,currentLoansCount:number,isAuthenticated:any,isCheckedOut:boolean,checkoutProduct:any ,isReviewLeft:boolean, submitReview:any }> = (props) => {
    function buttonRender(){
        if(props.isAuthenticated){
            if(!props.isCheckedOut && props.currentLoansCount<5){
                ...
                return(<p>
                    <b>Art checked out. Enjoy!</b>
                    </p>)
            }else if(!props.isCheckedOut){
                return(<p className="text-danger">Too many arts checked out.</p>)
            }
        }
